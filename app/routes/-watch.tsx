...
export default function WatchPage() {
  ...
  const isImage = videoMediaType === "image";
  const canLoadPlayback = isImage
    ? Boolean(videoData?.video)
  ...
  }, [getPlaybackSession, publicId, canLoadPlayback]);
      ...
      <div className="min-h-screen bg-[#f0f0e8] flex items-center justify-center p-4">
        <Card className="max-w-md w-full">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              This content is private, invalid, or no longer available.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link to="/" preload="intent" className="block">
              <Button variant="outline" className="w-full">Go to Signum</Button>
            </Link>
          </CardContent>
        </Card>
      </div>
